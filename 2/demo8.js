...
function animate(elapsedMilliseconds) {
    ...
    coordinates = myCoordinates
        .reset()
        // Stack it:
        .setSinus({sinRad: pi, sinIdxMultiplier: 0.5, amount: 50, sinIdxAddition: -5})
        .setSinus({sinRad: pi * 1.21, sinIdxMultiplier: 0.6, amount: 30, sinIdxAddition: 3})
        .setSinus({sinRad: -pi * 1.93, sinIdxMultiplier: 0.4, amount: 40, sinIdxAddition: -8})
        .setSinus({sinRad: -pi * 1.01, sinIdxMultiplier: 0.4, amount: 20, sinIdxAddition: 0})
        .setSinus({cosRad: pi * 0.91, cosIdxMultiplier: 0.4, amount: 20})
        .getCoordinates();
    for (var index = 0; index < coordinates.length; index += 1) {
